...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Click_and_Book.Models.Apartment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Click_and_Book.Models.ApartmentCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Click_and_Book.Models.Client", b =>
                {
            ...
            modelBuilder.Entity("Click_and_Book.Models.Owner", b =>
                {
                    b.HasBaseType("Microsoft.AspNetCore.Identity.IdentityUser");
            ...
            modelBuilder.Entity("Click_and_Book.Models.Apartment", b =>
                {
                    b.HasOne("Click_and_Book.Models.ApartmentCategory", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Click_and_Book.Models.Reservation", b =>
                {
                    b.HasOne("Click_and_Book.Models.Apartment", "Apartment")
                        .WithMany()
                        .HasForeignKey("ApartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Click_and_Book.Models.Client", "Client")
                        .WithMany()
